...
def parse_args():
    ...
    parser.add_argument('--l_maj_c', type=int, help='filter those majority less than maj_c')
    parser.add_argument('--r_maj_c', type=int, help='filter those majority greater than maj_c')
...
def process_answers(input_list: list[dict], gold_is_latex: bool, l_maj_c: int, r_maj_c: int) -> Union[list[dict], dict]:
...
def main():
    ...
    output_list, result_json = process_answers(input_list, args.gold_is_latex, l_maj_c=args.l_maj_c, r_maj_c=args.r_maj_c)
